...
- `config_file [optional]`: Defines the path to a `json` config file. (default: `.tinygo.json`)
- `cmd [optional]`: The TinyGo command that is used when executing. (default: `tinygo`)
